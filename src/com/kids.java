 ...
 * @author Caio
 */
public class kids extends Panel {
    ...
    private void initComponents() {
        ...
        query = java.beans.Beans.isDesignTime() ? null : entityManager.createQuery("SELECT a FROM Aluno4 a");
        ...
        org.jdesktop.beansbinding.ELProperty eLProperty = org.jdesktop.beansbinding.ELProperty.create("${selectedElement.registro4List}");
    ...
    private class FormListener implements java.awt.event.ActionListener {
        ...
        public void actionPerformed(java.awt.event.ActionEvent evt) {
            if (evt.getSource() == newButton) {
                kids.this.newButtonActionPerformed(evt);
            }
            else if (evt.getSource() == deleteButton) {
                kids.this.deleteButtonActionPerformed(evt);
            }
            else if (evt.getSource() == saveButton) {
                kids.this.saveButtonActionPerformed(evt);
            }
            else if (evt.getSource() == deleteDetailButton) {
                kids.this.deleteDetailButtonActionPerformed(evt);
            }
            else if (evt.getSource() == newDetailButton) {
                kids.this.newDetailButtonActionPerformed(evt);
            }
        }
    ...
    private void deleteDetailButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_deleteDetailButtonActionPerformed
        ...
        com.Aluno4 a = list.get(masterTable.convertRowIndexToModel(index));
        Collection<com.Registro4> rs = a.getRegistro4List();
        int[] selected = detailTable.getSelectedRows();
        List<com.Registro4> toRemove = new ArrayList<com.Registro4>(selected.length);
        for (int idx = 0; idx < selected.length; idx++) {

            selected[idx] = detailTable.convertRowIndexToModel(selected[idx]);

            int count = 0;
            Iterator<com.Registro4> iter = rs.iterator();
            while (count++ < selected[idx]) {
                iter.next();
            }
            com.Registro4 r = iter.next();
            toRemove.add(r);
    ...
    private void newDetailButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_newDetailButtonActionPerformed
        ...
        Collection<com.Registro4> rs = a.getRegistro4List();
        if (rs == null) {
            rs = new LinkedList<com.Registro4>();
            a.setRegistro4List((List) rs);
        }
        com.Registro4 r = new com.Registro4();
    ...
    private void deleteButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_deleteButtonActionPerformed
        ...
        List<com.Aluno4> toRemove = new ArrayList<com.Aluno4>(selected.length);
        for (int idx = 0; idx < selected.length; idx++) {
            com.Aluno4 a = list.get(masterTable.convertRowIndexToModel(selected[idx]));
            toRemove.add(a);
    ...
    private void saveButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_saveButtonActionPerformed
        try {
            ...
            rex.printStackTrace();
            entityManager.getTransaction().begin();
            List<com.Aluno4> merged = new ArrayList<com.Aluno4>(list.size());
            for (com.Aluno4 a : list) {
    ...
    private java.util.List<com.Aluno4> list;
