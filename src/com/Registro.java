 ...
 */
@Entity
@Table(name = "registro", catalog = "escoladominical", schema = "")
@NamedQueries({
    @NamedQuery(name = "Registro.findAll", query = "SELECT r FROM Registro r"),
    @NamedQuery(name = "Registro.findByIdRegistro", query = "SELECT r FROM Registro r WHERE r.idRegistro = :idRegistro"),
    @NamedQuery(name = "Registro.findByDataRegistro", query = "SELECT r FROM Registro r WHERE r.dataRegistro = :dataRegistro"),
    @NamedQuery(name = "Registro.findByTipoPresenca", query = "SELECT r FROM Registro r WHERE r.tipoPresenca = :tipoPresenca")})
public class Registro implements Serializable {
    ...
    public String toString() {
        return "com.Registro[ idRegistro=" + idRegistro + " ]";
    }
