 ...
 * @author Caio
 */
public class juniores extends Panel {
    ...
    private void initComponents() {
        ...
        query = java.beans.Beans.isDesignTime() ? null : entityManager.createQuery("SELECT a FROM Aluno6 a");
        ...
        org.jdesktop.beansbinding.ELProperty eLProperty = org.jdesktop.beansbinding.ELProperty.create("${selectedElement.registro6List}");
    ...
    private class FormListener implements java.awt.event.ActionListener {
        ...
        public void actionPerformed(java.awt.event.ActionEvent evt) {
            if (evt.getSource() == newButton) {
                juniores.this.newButtonActionPerformed(evt);
            }
            else if (evt.getSource() == deleteButton) {
                juniores.this.deleteButtonActionPerformed(evt);
            }
            else if (evt.getSource() == saveButton) {
                juniores.this.saveButtonActionPerformed(evt);
            }
            else if (evt.getSource() == deleteDetailButton) {
                juniores.this.deleteDetailButtonActionPerformed(evt);
            }
            else if (evt.getSource() == newDetailButton) {
                juniores.this.newDetailButtonActionPerformed(evt);
            }
        }
    ...
    private void deleteDetailButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_deleteDetailButtonActionPerformed
        ...
        com.Aluno6 a = list.get(masterTable.convertRowIndexToModel(index));
        Collection<com.Registro6> rs = a.getRegistro6List();
        int[] selected = detailTable.getSelectedRows();
        List<com.Registro6> toRemove = new ArrayList<com.Registro6>(selected.length);
        for (int idx = 0; idx < selected.length; idx++) {

            selected[idx] = detailTable.convertRowIndexToModel(selected[idx]);

            int count = 0;
            Iterator<com.Registro6> iter = rs.iterator();
            while (count++ < selected[idx]) {
                iter.next();
            }
            com.Registro6 r = iter.next();
            toRemove.add(r);
    ...
    private void newDetailButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_newDetailButtonActionPerformed
        ...
        Collection<com.Registro6> rs = a.getRegistro6List();
        if (rs == null) {
            rs = new LinkedList<com.Registro6>();
            a.setRegistro6List((List) rs);
        }
        com.Registro6 r = new com.Registro6();
    ...
    private void deleteButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_deleteButtonActionPerformed
        ...
        List<com.Aluno6> toRemove = new ArrayList<com.Aluno6>(selected.length);
        for (int idx = 0; idx < selected.length; idx++) {
            com.Aluno6 a = list.get(masterTable.convertRowIndexToModel(selected[idx]));
            toRemove.add(a);
    ...
    private void saveButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_saveButtonActionPerformed
        try {
            ...
            rex.printStackTrace();
            entityManager.getTransaction().begin();
            List<com.Aluno6> merged = new ArrayList<com.Aluno6>(list.size());
            for (com.Aluno6 a : list) {
    ...
    private java.util.List<com.Aluno6> list;
