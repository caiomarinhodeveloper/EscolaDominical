 ...
 * @author Caio
 */
public class discipulado extends Panel {
    ...
    private void initComponents() {
        ...
        query = java.beans.Beans.isDesignTime() ? null : entityManager.createQuery("SELECT a FROM Aluno3 a");
        ...
        org.jdesktop.beansbinding.ELProperty eLProperty = org.jdesktop.beansbinding.ELProperty.create("${selectedElement.registro3List}");
    ...
    private class FormListener implements java.awt.event.ActionListener {
        ...
        public void actionPerformed(java.awt.event.ActionEvent evt) {
            if (evt.getSource() == newButton) {
                discipulado.this.newButtonActionPerformed(evt);
            }
            else if (evt.getSource() == deleteButton) {
                discipulado.this.deleteButtonActionPerformed(evt);
            }
            else if (evt.getSource() == saveButton) {
                discipulado.this.saveButtonActionPerformed(evt);
            }
            else if (evt.getSource() == deleteDetailButton) {
                discipulado.this.deleteDetailButtonActionPerformed(evt);
            }
            else if (evt.getSource() == newDetailButton) {
                discipulado.this.newDetailButtonActionPerformed(evt);
            }
        }
    ...
    private void deleteDetailButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_deleteDetailButtonActionPerformed
        ...
        com.Aluno3 a = list.get(masterTable.convertRowIndexToModel(index));
        Collection<com.Registro3> rs = a.getRegistro3List();
        int[] selected = detailTable.getSelectedRows();
        List<com.Registro3> toRemove = new ArrayList<com.Registro3>(selected.length);
        for (int idx = 0; idx < selected.length; idx++) {

            selected[idx] = detailTable.convertRowIndexToModel(selected[idx]);

            int count = 0;
            Iterator<com.Registro3> iter = rs.iterator();
            while (count++ < selected[idx]) {
                iter.next();
            }
            com.Registro3 r = iter.next();
            toRemove.add(r);
    ...
    private void newDetailButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_newDetailButtonActionPerformed
        ...
        Collection<com.Registro3> rs = a.getRegistro3List();
        if (rs == null) {
            rs = new LinkedList<com.Registro3>();
            a.setRegistro3List((List) rs);
        }
        com.Registro3 r = new com.Registro3();
    ...
    private void deleteButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_deleteButtonActionPerformed
        ...
        List<com.Aluno3> toRemove = new ArrayList<com.Aluno3>(selected.length);
        for (int idx = 0; idx < selected.length; idx++) {
            com.Aluno3 a = list.get(masterTable.convertRowIndexToModel(selected[idx]));
            toRemove.add(a);
    ...
    private void saveButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_saveButtonActionPerformed
        try {
            ...
            rex.printStackTrace();
            entityManager.getTransaction().begin();
            List<com.Aluno3> merged = new ArrayList<com.Aluno3>(list.size());
            for (com.Aluno3 a : list) {
    ...
    private java.util.List<com.Aluno3> list;
