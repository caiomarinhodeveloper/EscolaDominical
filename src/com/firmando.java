 ...
 * @author Caio
 */
public class firmando extends Panel {
    ...
    private void initComponents() {
        ...
        query = java.beans.Beans.isDesignTime() ? null : entityManager.createQuery("SELECT a FROM Aluno5 a");
        ...
        org.jdesktop.swingbinding.JTableBinding.ColumnBinding columnBinding = jTableBinding.addColumnBinding(org.jdesktop.beansbinding.ELProperty.create("${nomeAluno}"));
        ...
        org.jdesktop.beansbinding.ELProperty eLProperty = org.jdesktop.beansbinding.ELProperty.create("${selectedElement.registro5List}");
    ...
    private class FormListener implements java.awt.event.ActionListener {
        ...
        public void actionPerformed(java.awt.event.ActionEvent evt) {
            if (evt.getSource() == newButton) {
                firmando.this.newButtonActionPerformed(evt);
            }
            else if (evt.getSource() == deleteButton) {
                firmando.this.deleteButtonActionPerformed(evt);
            }
            else if (evt.getSource() == saveButton) {
                firmando.this.saveButtonActionPerformed(evt);
            }
            else if (evt.getSource() == deleteDetailButton) {
                firmando.this.deleteDetailButtonActionPerformed(evt);
            }
            else if (evt.getSource() == newDetailButton) {
                firmando.this.newDetailButtonActionPerformed(evt);
            }
        }
    ...
    private void deleteDetailButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_deleteDetailButtonActionPerformed
        ...
        com.Aluno5 a = list.get(masterTable.convertRowIndexToModel(index));
        Collection<com.Registro5> rs = a.getRegistro5List();
        int[] selected = detailTable.getSelectedRows();
        List<com.Registro5> toRemove = new ArrayList<com.Registro5>(selected.length);
        for (int idx = 0; idx < selected.length; idx++) {

            selected[idx] = detailTable.convertRowIndexToModel(selected[idx]);

            int count = 0;
            Iterator<com.Registro5> iter = rs.iterator();
            while (count++ < selected[idx]) {
                iter.next();
            }
            com.Registro5 r = iter.next();
            toRemove.add(r);
    ...
    private void newDetailButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_newDetailButtonActionPerformed
        ...
        Collection<com.Registro5> rs = a.getRegistro5List();
        if (rs == null) {
            rs = new LinkedList<com.Registro5>();
            a.setRegistro5List((List) rs);
        }
        com.Registro5 r = new com.Registro5();
    ...
    private void deleteButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_deleteButtonActionPerformed
        ...
        List<com.Aluno5> toRemove = new ArrayList<com.Aluno5>(selected.length);
        for (int idx = 0; idx < selected.length; idx++) {
            com.Aluno5 a = list.get(masterTable.convertRowIndexToModel(selected[idx]));
            toRemove.add(a);
    ...
    private void saveButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_saveButtonActionPerformed
        try {
            ...
            rex.printStackTrace();
            entityManager.getTransaction().begin();
            List<com.Aluno5> merged = new ArrayList<com.Aluno5>(list.size());
            for (com.Aluno5 a : list) {
    ...
    private java.util.List<com.Aluno5> list;
